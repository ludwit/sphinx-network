...
#define SPHINX_PAYLOAD_SIZE 128
#define SPHINX_MESSAGE_SIZE (HEADER_SIZE + SPHINX_PAYLOAD_SIZE)
...
static const struct network_node network_pki[] =
{
    ...
    {
        /* ipv6 address */
        {{0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3c, 0xa7, 0x09, 0xff, 0xfe, 0x94, 0xca, 0xa2}},
        /* public key */
    ...
    {
        /* ipv6 address */
        {{0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6c, 0x76, 0xa0, 0xff, 0xfe, 0xbd, 0x9e, 0xae}},
        /* public key */
    ...
    {
        /* ipv6 address */
        {{0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8c, 0x9d, 0xc1, 0xff, 0xfe, 0xc6, 0x80, 0x66}},
        /* public key */
    ...
    {
        /* ipv6 address */
        {{0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x54, 0x85, 0xff, 0xfe, 0x16, 0xd8, 0xe8}},
        /* public key */
